...
If there is at least one AI player, you are allowed to set the game difficulty from 1 easy to 4 hard, then the difficulty will be used as depth in the MiniMax algorithm. 
